...
const Charts = () => {
    ...
    const innerHeightBar = HEIGHT - margin.top - margin.bottom - 150;
...
//Hint: use d3.scaleBand for xScaleBar
    ...
    const yScaleBar = d3.scaleLinear()
        .domain([0, 4000]) // d3.max(dataAll, d => d.start)])
    ...
    return (
        <Container >
            ...
            <Row className='justify-content-md-center'>
                ...
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        <BarChart offsetX={margin.left} offsetY={margin.top+20} data={data} xScale={xScaleBar} 
            ...
            */
            <Tooltip d={selectedStation} x={tooltipX} y={tooltipY} />
            }
        </Container>
    )   
}
